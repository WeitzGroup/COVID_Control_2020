function cost = heuristic_applied_grid(line_params, cmin, cmax, grid_idx, cbase)
...
trajectory_count = 10;
sigma_fraction = 0.02;       % 2% of val is sigma       

state_sol_heuristic(1,:) = [parsT.t0, initial_state]; 
...
cost = total_deaths*500/1e6 + working_days_frac;
matFileName = sprintf('heuristic_applied_grid_%d.mat', grid_idx);
%matFileName = sprintf('full_lockdown_%d.mat', grid_idx);
%matFileName = sprintf('full_open.mat');
save(matFileName)
